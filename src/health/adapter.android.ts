...
export const nativeHealthAdapter: HealthAdapter = expoGo
  ? {
      ...
      requestPermissions: async () => {
        throw new Error("Install a MetricRally development or preview build to connect Health Connect.");
      },
      read: async () => [],
      openSettings: async () => {
        throw new Error("Health Connect settings require an installed MetricRally build.");
      },
    }
  : {
