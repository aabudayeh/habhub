...
const commonTranslationRows = [
  ...
  ["Daily overview", "النظرة اليومية", "Resumen diario", "每日概览", "Dagsöversikt", "Tagesübersicht", "Обзор дня", "Vue d’ensemble quotidienne"],
  ["Daily overview row", "صف النظرة اليومية", "Fila de resumen diario", "每日概览行", "Rad för dagsöversikt", "Zeile der Tagesübersicht", "Строка обзора дня", "Ligne de vue d’ensemble quotidienne"],
  ["{time} row", "صف {time}", "Fila de {time}", "{time} 行", "Rad {time}", "Zeile {time}", "Строка {time}", "Ligne {time}"],
  ["Collapses this schedule row", "يطوي صف الجدول هذا", "Contrae esta fila del horario", "折叠此日程行", "Fäller ihop den här schemaraden", "Klappt diese Zeitplanzeile ein", "Сворачивает эту строку расписания", "Réduit cette ligne du planning"],
  ["Expands this schedule row", "يوسّع صف الجدول هذا", "Expande esta fila del horario", "展开此日程行", "Fäller ut den här schemaraden", "Klappt diese Zeitplanzeile aus", "Разворачивает эту строку расписания", "Développe cette ligne du planning"],
  ["{date}, {slot}, {count} schedule items", "{date}، {slot}، {count} عناصر في الجدول", "{date}, {slot}, {count} elementos programados", "{date}，{slot}，{count} 个日程项目", "{date}, {slot}, {count} schemaposter", "{date}, {slot}, {count} Zeitplaneinträge", "{date}, {slot}, элементов расписания: {count}", "{date}, {slot}, {count} éléments planifiés"],
  ["Opens this schedule slot. Long press to add an item", "يفتح خانة الجدول هذه. اضغط مطولاً لإضافة عنصر", "Abre este espacio del horario. Mantén pulsado para añadir un elemento", "打开此日程时段。长按可添加项目", "Öppnar den här schematiden. Tryck länge för att lägga till en post", "Öffnet dieses Zeitfenster. Lange drücken, um einen Eintrag hinzuzufügen", "Открывает этот интервал расписания. Нажмите и удерживайте, чтобы добавить элемент", "Ouvre ce créneau du planning. Appuyez longuement pour ajouter un élément"],
  ["Opens all items in this schedule slot. Long press to add an item", "يفتح كل العناصر في خانة الجدول هذه. اضغط مطولاً لإضافة عنصر", "Abre todos los elementos de este espacio del horario. Mantén pulsado para añadir un elemento", "打开此日程时段中的所有项目。长按可添加项目", "Öppnar alla poster i den här schematiden. Tryck länge för att lägga till en post", "Öffnet alle Einträge in diesem Zeitfenster. Lange drücken, um einen Eintrag hinzuzufügen", "Открывает все элементы в этом интервале расписания. Нажмите и удерживайте, чтобы добавить элемент", "Ouvre tous les éléments de ce créneau. Appuyez longuement pour ajouter un élément"],
  ["{count} more items. {slot}", "{count} عناصر أخرى. {slot}", "{count} elementos más. {slot}", "还有 {count} 个项目。{slot}", "Ytterligare {count} poster. {slot}", "{count} weitere Einträge. {slot}", "Ещё элементов: {count}. {slot}", "{count} éléments supplémentaires. {slot}"],
  ["Opens all items in this schedule slot", "يفتح كل العناصر في خانة الجدول هذه", "Abre todos los elementos de este espacio del horario", "打开此日程时段中的所有项目", "Öppnar alla poster i den här schematiden", "Öffnet alle Einträge in diesem Zeitfenster", "Открывает все элементы в этом интервале расписания", "Ouvre tous les éléments de ce créneau"],
  ["Opens the meal time editor", "يفتح محرر وقت الوجبة", "Abre el editor de la hora de la comida", "打开用餐时间编辑器", "Öppnar redigeringen av måltidstid", "Öffnet die Bearbeitung der Mahlzeitzeit", "Открывает редактор времени приёма пищи", "Ouvre l’éditeur de l’heure du repas"],
  ...
  ["No tracker setup is needed for this goal. Friend features stay ready for you.", "لا يلزم إعداد أي متعقب لهذا الهدف. ستظل ميزات الأصدقاء جاهزة لك.", "No necesitas configurar ningún rastreador para este objetivo. Las funciones de amigos estarán listas para ti.", "此目标无需设置追踪器。好友功能已为你准备好。", "Ingen spårarinställning behövs för det här målet. Vänfunktionerna är redo för dig.", "Für dieses Ziel ist keine Tracker-Einrichtung nötig. Die Freunde-Funktionen stehen für dich bereit.", "Для этой цели не нужно настраивать трекеры. Функции для друзей уже готовы.", "Aucune configuration de suivi n’est nécessaire pour cet objectif. Les fonctions entre amis sont prêtes."],
  ...
  ["Workout timer", "مؤقت التمرين", "Temporizador de entrenamiento", "训练计时器", "Träningstimer", "Trainingstimer", "Таймер тренировки", "Minuteur d’entraînement"],
  ["Timer progression", "تسلسل المؤقت", "Progresión del temporizador", "计时器流程", "Timerflöde", "Timerablauf", "Ход таймера", "Progression du minuteur"],
  ["Sets & rests", "المجموعات والراحة", "Series y descansos", "组与休息", "Set och vila", "Sätze und Pausen", "Подходы и отдых", "Séries et repos"],
  ["Whole workout", "التمرين بالكامل", "Entrenamiento completo", "整个训练", "Hela träningspasset", "Gesamtes Training", "Вся тренировка", "Entraînement entier"],
  ["Sets & rests · Next advances the workout.", "المجموعات والراحة · زر التالي يقدّم التمرين.", "Series y descansos · Siguiente avanza el entrenamiento.", "组与休息 · 点击下一步推进训练。", "Set och vila · Nästa för träningspasset framåt.", "Sätze und Pausen · Weiter führt durch das Training.", "Подходы и отдых · Далее продвигает тренировку.", "Séries et repos · Suivant fait avancer l’entraînement."],
  ["Whole workout · mark sets manually.", "التمرين بالكامل · علّم المجموعات يدويًا.", "Entrenamiento completo · marca las series manualmente.", "整个训练 · 手动标记各组。", "Hela träningspasset · markera set manuellt.", "Gesamtes Training · Sätze manuell markieren.", "Вся тренировка · отмечайте подходы вручную.", "Entraînement entier · cochez les séries manuellement."],
  ["Next moves through each set and rest.", "ينتقل زر التالي عبر كل مجموعة وفترة راحة.", "Siguiente recorre cada serie y descanso.", "下一步会依次经过每组和休息。", "Nästa går igenom varje set och vila.", "Weiter führt durch jeden Satz und jede Pause.", "Далее проходит по каждому подходу и отдыху.", "Suivant parcourt chaque série et chaque repos."],
  ["One Start/Pause/Finish timer; mark sets manually.", "مؤقت واحد للبدء والإيقاف المؤقت والإنهاء؛ علّم المجموعات يدويًا.", "Un temporizador de inicio, pausa y finalización; marca las series manualmente.", "一个开始、暂停和结束计时器；手动标记各组。", "En timer för start, paus och avslut; markera set manuellt.", "Ein Timer für Start, Pause und Ende; Sätze manuell markieren.", "Один таймер запуска, паузы и завершения; отмечайте подходы вручную.", "Un minuteur démarrer, pause et terminer ; cochez les séries manuellement."],
  ["Finish when you're done", "أنهِ عند الانتهاء", "Finaliza cuando termines", "完成后结束", "Avsluta när du är klar", "Beenden, wenn du fertig bist", "Завершите, когда закончите", "Terminez lorsque vous avez fini"],
  ["Complete all", "إكمال الكل", "Completar todo", "全部完成", "Slutför alla", "Alle abschließen", "Завершить все", "Tout terminer"],
  ["Complete all workout sets", "إكمال جميع مجموعات التمرين", "Completar todas las series del entrenamiento", "完成所有训练组", "Slutför alla träningsset", "Alle Trainingssätze abschließen", "Завершить все подходы тренировки", "Terminer toutes les séries de l’entraînement"],
  ...
  ["The account service is temporarily unavailable. Please try again shortly.", "\u062e\u062f\u0645\u0629 \u0627\u0644\u062d\u0633\u0627\u0628 \u063a\u064a\u0631 \u0645\u062a\u0627\u062d\u0629 \u0645\u0624\u0642\u062a\u064b\u0627. \u064a\u064f\u0631\u062c\u0649 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062e\u0631\u0649 \u0628\u0639\u062f \u0642\u0644\u064a\u0644.", "El servicio de cuentas no est\u00e1 disponible temporalmente. Int\u00e9ntalo de nuevo en breve.", "\u8d26\u6237\u670d\u52a1\u6682\u65f6\u4e0d\u53ef\u7528\u3002\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002", "Kontotj\u00e4nsten \u00e4r tillf\u00e4lligt otillg\u00e4nglig. F\u00f6rs\u00f6k igen snart.", "Der Kontodienst ist vor\u00fcbergehend nicht verf\u00fcgbar. Bitte versuche es gleich noch einmal.", "\u0421\u0435\u0440\u0432\u0438\u0441 \u0443\u0447\u0435\u0442\u043d\u044b\u0445 \u0437\u0430\u043f\u0438\u0441\u0435\u0439 \u0432\u0440\u0435\u043c\u0435\u043d\u043d\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u0435\u043d. \u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u043e\u043f\u044b\u0442\u043a\u0443 \u0447\u0443\u0442\u044c \u043f\u043e\u0437\u0436\u0435.", "Le service de compte est temporairement indisponible. R\u00e9essayez dans un instant."],
  ["Precise reminder timing", "\u062a\u0648\u0642\u064a\u062a \u062f\u0642\u064a\u0642 \u0644\u0644\u062a\u0630\u0643\u064a\u0631\u0627\u062a", "Horario preciso de los recordatorios", "\u7cbe\u786e\u7684\u63d0\u9192\u65f6\u95f4", "Exakt p\u00e5minnelsetid", "Genaue Erinnerungszeiten", "\u0422\u043e\u0447\u043d\u043e\u0435 \u0432\u0440\u0435\u043c\u044f \u043d\u0430\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u0439", "Horaire pr\u00e9cis des rappels"],
  ["Checking Android reminder timing...", "\u062c\u0627\u0631\u064d \u0627\u0644\u062a\u062d\u0642\u0642 \u0645\u0646 \u062a\u0648\u0642\u064a\u062a \u062a\u0630\u0643\u064a\u0631\u0627\u062a Android...", "Comprobando el horario de los recordatorios de Android...", "\u6b63\u5728\u68c0\u67e5 Android \u63d0\u9192\u65f6\u95f4...", "Kontrollerar Androids p\u00e5minnelsetider...", "Android-Erinnerungszeiten werden gepr\u00fcft...", "\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c \u0432\u0440\u0435\u043c\u044f \u043d\u0430\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u0439 Android...", "V\u00e9rification de l\u2019horaire des rappels Android..."],
  ["Android allows HabHub reminders to fire at their precise scheduled time.", "\u064a\u0633\u0645\u062d Android \u0644\u0640 HabHub \u0628\u0625\u0631\u0633\u0627\u0644 \u0627\u0644\u062a\u0630\u0643\u064a\u0631\u0627\u062a \u0641\u064a \u0648\u0642\u062a\u0647\u0627 \u0627\u0644\u0645\u062d\u062f\u062f \u0628\u062f\u0642\u0629.", "Android permite que los recordatorios de HabHub se activen exactamente a la hora programada.", "Android \u5141\u8bb8 HabHub \u5728\u9884\u5b9a\u7684\u7cbe\u786e\u65f6\u95f4\u53d1\u51fa\u63d0\u9192\u3002", "Android till\u00e5ter att HabHub-p\u00e5minnelser visas exakt p\u00e5 den schemalagda tiden.", "Android erlaubt HabHub, Erinnerungen genau zur geplanten Zeit auszul\u00f6sen.", "Android \u0440\u0430\u0437\u0440\u0435\u0448\u0430\u0435\u0442 HabHub \u043f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0442\u044c \u043d\u0430\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u044f \u0442\u043e\u0447\u043d\u043e \u0432 \u0437\u0430\u043f\u043b\u0430\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u043e\u0435 \u0432\u0440\u0435\u043c\u044f.", "Android autorise HabHub \u00e0 d\u00e9clencher les rappels exactement \u00e0 l\u2019heure pr\u00e9vue."],
  ["Android will use its inexact fallback, so reminders still arrive but may be delayed. Tap to review exact-alarm access.", "\u0633\u064a\u0633\u062a\u062e\u062f\u0645 Android \u062a\u0648\u0642\u064a\u062a\u064b\u0627 \u062a\u0642\u0631\u064a\u0628\u064a\u064b\u0627 \u0627\u062d\u062a\u064a\u0627\u0637\u064a\u064b\u0627\u060c \u0644\u0630\u0627 \u0633\u062a\u0635\u0644 \u0627\u0644\u062a\u0630\u0643\u064a\u0631\u0627\u062a \u0648\u0644\u0643\u0646 \u0642\u062f \u062a\u062a\u0623\u062e\u0631. \u0627\u0636\u063a\u0637 \u0644\u0645\u0631\u0627\u062c\u0639\u0629 \u0635\u0644\u0627\u062d\u064a\u0629 \u0627\u0644\u0645\u0646\u0628\u0647\u0627\u062a \u0627\u0644\u062f\u0642\u064a\u0642\u0629.", "Android usar\u00e1 el modo aproximado de reserva, por lo que los recordatorios seguir\u00e1n llegando, aunque pueden retrasarse. Toca para revisar el acceso a alarmas exactas.", "Android \u5c06\u4f7f\u7528\u975e\u7cbe\u786e\u7684\u5907\u7528\u65b9\u5f0f\uff0c\u56e0\u6b64\u63d0\u9192\u4ecd\u4f1a\u5230\u8fbe\uff0c\u4f46\u53ef\u80fd\u5ef6\u8fdf\u3002\u70b9\u6309\u67e5\u770b\u7cbe\u786e\u95f9\u949f\u6743\u9650\u3002", "Android anv\u00e4nder reservl\u00e4get med ungef\u00e4rlig tid, s\u00e5 p\u00e5minnelser kommer fortfarande men kan bli f\u00f6rsenade. Tryck f\u00f6r att granska \u00e5tkomst till exakta alarm.", "Android verwendet ersatzweise eine ungef\u00e4hre Zeit. Erinnerungen kommen weiterhin an, k\u00f6nnen aber versp\u00e4tet sein. Tippe, um den Zugriff auf genaue Alarme zu pr\u00fcfen.", "Android \u0431\u0443\u0434\u0435\u0442 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c \u0440\u0435\u0437\u0435\u0440\u0432\u043d\u044b\u0439 \u043d\u0435\u0442\u043e\u0447\u043d\u044b\u0439 \u0440\u0435\u0436\u0438\u043c, \u043f\u043e\u044d\u0442\u043e\u043c\u0443 \u043d\u0430\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u044f \u043f\u0440\u0438\u0434\u0443\u0442, \u043d\u043e \u043c\u043e\u0433\u0443\u0442 \u0437\u0430\u0434\u0435\u0440\u0436\u0430\u0442\u044c\u0441\u044f. \u041d\u0430\u0436\u043c\u0438\u0442\u0435, \u0447\u0442\u043e\u0431\u044b \u043f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c \u0434\u043e\u0441\u0442\u0443\u043f \u043a \u0442\u043e\u0447\u043d\u044b\u043c \u0431\u0443\u0434\u0438\u043b\u044c\u043d\u0438\u043a\u0430\u043c.", "Android utilisera son mode de secours impr\u00e9cis. Les rappels arriveront toujours, mais pourront \u00eatre retard\u00e9s. Touchez pour v\u00e9rifier l\u2019acc\u00e8s aux alarmes exactes."],
  ["Precise timing settings unavailable", "\u0625\u0639\u062f\u0627\u062f\u0627\u062a \u0627\u0644\u062a\u0648\u0642\u064a\u062a \u0627\u0644\u062f\u0642\u064a\u0642 \u063a\u064a\u0631 \u0645\u062a\u0627\u062d\u0629", "La configuraci\u00f3n de horario preciso no est\u00e1 disponible", "\u7cbe\u786e\u65f6\u95f4\u8bbe\u7f6e\u4e0d\u53ef\u7528", "Inst\u00e4llningar f\u00f6r exakt tid \u00e4r inte tillg\u00e4ngliga", "Einstellungen f\u00fcr genaue Zeiten sind nicht verf\u00fcgbar", "\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u0442\u043e\u0447\u043d\u043e\u0433\u043e \u0432\u0440\u0435\u043c\u0435\u043d\u0438 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b", "Param\u00e8tres de pr\u00e9cision indisponibles"],
  ["Android exact-alarm settings could not be opened.", "\u062a\u0639\u0630\u0631 \u0641\u062a\u062d \u0625\u0639\u062f\u0627\u062f\u0627\u062a \u0627\u0644\u0645\u0646\u0628\u0647 \u0627\u0644\u062f\u0642\u064a\u0642 \u0641\u064a Android.", "No se pudo abrir la configuraci\u00f3n de alarmas exactas de Android.", "\u65e0\u6cd5\u6253\u5f00 Android \u7cbe\u786e\u95f9\u949f\u8bbe\u7f6e\u3002", "Det gick inte att \u00f6ppna Androids inst\u00e4llningar f\u00f6r exakta alarm.", "Die Android-Einstellungen f\u00fcr genaue Alarme konnten nicht ge\u00f6ffnet werden.", "\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043e\u0442\u043a\u0440\u044b\u0442\u044c \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u0442\u043e\u0447\u043d\u044b\u0445 \u0431\u0443\u0434\u0438\u043b\u044c\u043d\u0438\u043a\u043e\u0432 Android.", "Impossible d\u2019ouvrir les param\u00e8tres Android des alarmes exactes."],
] satisfies readonly TranslationRow[];

const templateTranslationRows = [
  ["{value} days in a row. Keep the rhythm that works for you.", "{value} \u064a\u0648\u0645\u064b\u0627 \u0645\u062a\u062a\u0627\u0644\u064a\u064b\u0627. \u062d\u0627\u0641\u0638 \u0639\u0644\u0649 \u0627\u0644\u0625\u064a\u0642\u0627\u0639 \u0627\u0644\u0630\u064a \u064a\u0646\u0627\u0633\u0628\u0643.", "{value} d\u00edas seguidos. Mant\u00e9n el ritmo que te funciona.", "\u8fde\u7eed {value} \u5929\u3002\u4fdd\u6301\u9002\u5408\u4f60\u7684\u8282\u594f\u3002", "{value} dagar i rad. Forts\u00e4tt med rytmen som fungerar f\u00f6r dig.", "{value} Tage in Folge. Behalte den Rhythmus bei, der f\u00fcr dich funktioniert.", "{value} \u0434\u043d\u0435\u0439 \u043f\u043e\u0434\u0440\u044f\u0434. \u0421\u043e\u0445\u0440\u0430\u043d\u044f\u0439\u0442\u0435 \u0443\u0434\u043e\u0431\u043d\u044b\u0439 \u0434\u043b\u044f \u0432\u0430\u0441 \u0440\u0438\u0442\u043c.", "{value} jours de suite. Gardez le rythme qui vous convient."],
  ["{value} days strong. Finish today's {value} goal to keep it going.", "{value} \u064a\u0648\u0645\u064b\u0627 \u0645\u062a\u062a\u0627\u0644\u064a\u064b\u0627. \u0623\u0643\u0645\u0644 \u0647\u062f\u0641 {value} \u0644\u0644\u064a\u0648\u0645 \u0644\u0644\u062d\u0641\u0627\u0638 \u0639\u0644\u0649 \u0627\u0644\u0633\u0644\u0633\u0644\u0629.", "{value} d\u00edas seguidos. Completa hoy el objetivo de {value} para mantener la racha.", "\u5df2\u8fde\u7eed {value} \u5929\u3002\u5b8c\u6210\u4eca\u5929\u7684 {value} \u76ee\u6807\u4ee5\u4fdd\u6301\u8fde\u7eed\u8bb0\u5f55\u3002", "{value} dagar i rad. Slutf\u00f6r dagens m\u00e5l f\u00f6r {value} f\u00f6r att beh\u00e5lla sviten.", "{value} Tage in Folge. Erreiche heute dein {value}-Ziel, um die Serie zu halten.", "{value} \u0434\u043d\u0435\u0439 \u043f\u043e\u0434\u0440\u044f\u0434. \u0412\u044b\u043f\u043e\u043b\u043d\u0438\u0442\u0435 \u0441\u0435\u0433\u043e\u0434\u043d\u044f\u0448\u043d\u044e\u044e \u0446\u0435\u043b\u044c \u00ab{value}\u00bb, \u0447\u0442\u043e\u0431\u044b \u0441\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0441\u0435\u0440\u0438\u044e.", "{value} jours de suite. Atteignez aujourd\u2019hui l\u2019objectif {value} pour pr\u00e9server la s\u00e9rie."],
  ["{value} of {value} exercises \u00b7 {value} sets \u00b7 {value} kg", "{value} \u0645\u0646 {value} \u062a\u0645\u0627\u0631\u064a\u0646 \u00b7 {value} \u0645\u062c\u0645\u0648\u0639\u0627\u062a \u00b7 {value} \u0643\u062c\u0645", "{value} de {value} ejercicios \u00b7 {value} series \u00b7 {value} kg", "{value}/{value} \u4e2a\u7ec3\u4e60 \u00b7 {value} \u7ec4 \u00b7 {value} \u516c\u65a4", "{value} av {value} \u00f6vningar \u00b7 {value} set \u00b7 {value} kg", "{value} von {value} \u00dcbungen \u00b7 {value} S\u00e4tze \u00b7 {value} kg", "{value} \u0438\u0437 {value} \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439 \u00b7 {value} \u043f\u043e\u0434\u0445\u043e\u0434\u043e\u0432 \u00b7 {value} \u043a\u0433", "{value} sur {value} exercices \u00b7 {value} s\u00e9ries \u00b7 {value} kg"],
