...
const BASE_METRICS: MetricDefinition[] = [
  ...
  { id:'cholesterol',name:'Cholesterol',icon:'heart-outline',color:'#9B3F72',unit:'mg',dataType:'number',aggregation:'sum',rankingDirection:'lower',goal:{kind:'at_most',target:300},scoreWeight:0,defaultVisibility:'group',sections:{today:false,group:false,insights:true},order:23,activeFrom:dateKeyWithOffset(-29) },
  { id:'potassium',name:'Potassium',icon:'leaf-outline',color:'#5F8C57',unit:'mg',dataType:'number',aggregation:'sum',rankingDirection:'higher',goal:{kind:'at_least',target:3500},scoreWeight:0,defaultVisibility:'group',sections:{today:false,group:false,insights:true},order:24,activeFrom:dateKeyWithOffset(-29) },
  { id:'calcium',name:'Calcium',icon:'medical-outline',color:'#71839B',unit:'mg',dataType:'number',aggregation:'sum',rankingDirection:'higher',goal:{kind:'at_least',target:1000},scoreWeight:0,defaultVisibility:'group',sections:{today:false,group:false,insights:true},order:25,activeFrom:dateKeyWithOffset(-29) },
  { id:'iron',name:'Iron',icon:'fitness-outline',color:'#8D5A45',unit:'mg',dataType:'number',aggregation:'sum',rankingDirection:'higher',goal:{kind:'at_least',target:8},scoreWeight:0,defaultVisibility:'group',sections:{today:false,group:false,insights:true},order:26,activeFrom:dateKeyWithOffset(-29) },
  { id:'magnesium',name:'Magnesium',icon:'sparkles-outline',color:'#7462A8',unit:'mg',dataType:'number',aggregation:'sum',rankingDirection:'higher',goal:{kind:'at_least',target:400},scoreWeight:0,defaultVisibility:'group',sections:{today:false,group:false,insights:true},order:27,activeFrom:dateKeyWithOffset(-29) },
