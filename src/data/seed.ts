...
const BASE_METRICS: MetricDefinition[] = [
  ...
  },
  {
    ...
    aggregation: "latest",
    rankingDirection: "higher",
    goal: { kind: "at_least", target: 2200 },
    goalEnabled: false,
    scoreWeight: 0,
    defaultVisibility: "group",
  ...
  },
  {
    ...
    workoutQualification: DEFAULT_WORKOUT_QUALIFICATION,
    sections: { today: false, group: false, insights: true },
    order: 5,
    activeFrom: dateKeyWithOffset(-29),
  },
  ...
  return {
    ...
    settings: {
      ...
      healthSync: {
        ...
        liveStepSources: ["samsung_health", "android_device"],
        liveStepCombination: "priority",
        liveStepStrategyVersion: 2,
        dataTypes: {
          steps: true,
          active_energy: true,
          total_energy: true,
      ...
      todayTileLimit: 5,
      todayLayoutMode: "pages",
      todayTilesPerPage: 4,
      leaderboardLayoutMode: "pages",
      leaderboardCardsPerPage: 2,
      darkMode: true,
      ...
      showFeaturedTodoProgress: false,
      ...
      leaderboardDetailDateNavigatorCollapsed: true,
