...
const scenes = [
  ...
  { file: "02-tracker-history.jpg", route: "/metric-detail?metric=steps", ready: "Steps" },
  {
    file: "03-progress-grid.jpg",
    route: "/insights",
    ready: "Progress",
    action: clickText("Grid map"),
  },
  {
  ...
  { file: "12-quick-guide.jpg", route: "/quick-guide", ready: "Guided tutorials" },
  {
    ...
    tutorialStep: {
      ...
      guideVersion: 3,
      stepId: "full.today.edit",
      stepIndex: 3,
    },
    tutorialReady: "Enter edit mode",
  ...
  { file: "15-custom-tracker.jpg", route: "/metric-editor?id=water&duplicate=1", ready: "Duplicate Water" },
