...
Version 0.3.1 opens as a normal 400 x 560 toolbar popup. It contains HabHub's
...
button to open the full website. Sign in to `https://sethypoo-habhub.expo.app` with the
...
The production companion page is `https://sethypoo-habhub.expo.app/extension`.
